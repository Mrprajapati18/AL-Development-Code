report 50004 "Day Wise Ledger "  // Durgesh 09062026
{
        ...
        layout
        {
            area(Content)
            {
                ...
                group("Select Report")
                {
                    ...
                    field(MonthWiseReportBool; MonthWiseReportBool)
                    {
                        ApplicationArea = All;
                        Caption = 'Month Wise Report';
                        ToolTip = 'Enable this to print Month Wise Ledger Report.';
                    }
                    field(VoucherWiseLedgerBool; VoucherWiseLedgerBool)
                    {
                        ApplicationArea = All;
                        Caption = 'Voucher Wise Ledger';
                        ToolTip = 'Enable this to print Voucher Wise Ledger Report.';
                    }
                }
    ...
    var
        ...
        MonthWiseReportBool: Boolean;
        VoucherWiseLedgerBool: Boolean;
