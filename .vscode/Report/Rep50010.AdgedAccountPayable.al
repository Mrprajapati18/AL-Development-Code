report 50010 "Adged Account Payable"
{

    DefaultLayout = RDLC;
    UsageCategory = ReportsAndAnalysis;
    ApplicationArea = all;
    RDLCLayout = 'Layouts\AgedAccountsPayablenew.rdl';
    ...
    dataset
    {
        dataitem(Vendor; Vendor)
        {
            ...
            RequestFilterFields = "No.", "MSME Vendor";
            ...
            column(PaymentMethodFP; "Payment Method Code")
            {
            }
            ...
            dataitem(CurrencyLoop; Integer)
            {
                ...
                dataitem(TempVendortLedgEntryLoop; Integer)
                {
                    ...
                    column(ExtDocno; VendorLedgEntryEndingDate."External Document No.")
                    {
                    }
                    ...
                    column(UserID; VendorLedgEntryEndingDate."User ID")
                    {
                    }
                    ...
                    column(PurchInvHeadeDocDate; PurchInvHeadeDocDate)
                    {
                    }
                    ...
                    begin
                        ...
                        Clear(PurchInvHeadeDocDate);
                        PurchInvHeader.Reset();
                        PurchInvHeader.SetRange("No.", VendorLedgEntryEndingDate."Document No.");
                        if PurchInvHeader.FindFirst()then PurchInvHeadeDocDate:=PurchInvHeader."Posting Date";
                    end;
