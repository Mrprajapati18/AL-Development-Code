...
report 50001 DebitNote // Durgesh 06 May 2026
{
    ApplicationArea = All;
    Caption = 'DebitNote';
    UsageCategory = ReportsAndAnalysis;
    DefaultLayout = RDLC;
    RDLCLayout = 'Layouts\DebitNote.rdl';
    dataset
    {
        dataitem("PurchCrMemoHdr"; "Purch. Cr. Memo Hdr.")
        {
            ...
            dataitem("PurchCrMemoLine"; "Purch. Cr. Memo Line")
            {
                ...
                begin
                    ...
                    GrandTotalGSTAmt += TotalAmtLineGSt;


                    GrandFinalTotal := GrandTotalBaseAmt + GrandTotalGSTAmt;

                    FormatNoText(Amountinwords, GrandFinalTotal, PurchCrMemoHdr."Currency Code");
                end;
            }
